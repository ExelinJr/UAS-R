...
auc2t = plot(roc2t, auc.polygon = TRUE, print.auc = TRUE, main = "Decison Tree Training")
auc2 = plot(roc2, auc.polygon = TRUE, print.auc = TRUE, main = "Decison Tree Testing")
...
## All Plot
```{r}
par(mfrow = c(2, 3)); plot(roc1t, auc.polygon = TRUE, print.auc = TRUE, main = "Logistic Regression Training"); plot(roc2t, auc.polygon = TRUE, print.auc = TRUE, main = "Binary Tree Training"); plot(roc3t, auc.polygon = TRUE, print.auc = TRUE, main = "SVM Training"); plot(roc4t, auc.polygon = TRUE, print.auc = TRUE, main = "Random Forest Training"); plot(roc5t, auc.polygon = TRUE, print.auc = TRUE, main = "Gradient Boosting Training"); plot(roc6t, auc.polygon = TRUE, print.auc = TRUE, main = "Linear Regression Training")

par(mfrow = c(2, 3)); plot(roc1, auc.polygon = TRUE, print.auc = TRUE, main = "Logistic Regression Testing"); plot(roc2, auc.polygon = TRUE, print.auc = TRUE, main = "Binary Tree Testing"); plot(roc3, auc.polygon = TRUE, print.auc = TRUE, main = "SVM Testing"); plot(roc4, auc.polygon = TRUE, print.auc = TRUE, main = "Random Forest Testing"); plot(roc5, auc.polygon = TRUE, print.auc = TRUE, main = "Gradient Boosting Testing"); plot(roc6, auc.polygon = TRUE, print.auc = TRUE, main = "Linear Regression Testing")
