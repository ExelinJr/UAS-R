...
# testing accuracy
probs2 = predict(model2, newdata=testing, type="prob")
accuracy2 = mean(testing$LULUS == as.numeric(probs>0.5))
print(accuracy)

testing$LULUS <- as.factor(testing$LULUS)
predicted2 <- as.factor(as.numeric(probs2 > 0.5))
confusionMatrix(testing$LULUS, predicted2)
